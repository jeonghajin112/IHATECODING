...
mod phase3b_bridge_tests {
    ...
    fn production_agent_v2_migrates_v1_and_restores_eight_same_directory_panes() {
        ...
        let mut canonical_terminals = (0..8)
            .map(|index| backfill_terminal(&format!("current-{index}"), r"C:\KYUMWEB"))
            .collect::<Vec<_>>();
        ...
        state.projects[0].folder_path = r"C:\KYUMWEB".to_owned();
        ...
        legacy.projects[0].folder_path = r"c:/kyumweb/./".to_owned();
